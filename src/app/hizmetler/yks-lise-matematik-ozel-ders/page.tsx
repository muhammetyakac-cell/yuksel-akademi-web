...
export const metadata: Metadata = {
  title: 'İzmir YKS & Lise Matematik Özel Ders | Yükselİn Akademi',
...
export default function YksHizmetPage() {
  const data = {
    ...
    heroSubtitle: 'Dokuz Eylül Üniversitesi mezunu öğretmen Gülçin Demir liderliğindeki Yükselİn Akademi ile İzmir genelinde birebir matematik özel ders ve sınav stratejileri.',
    curriculum: [
            ...
            <div 
              ...
              dangerouslySetInnerHTML={{
                __html: `
                  ...
                  <p>YKS hazırlığı sadece konuyu bilmekle sınırlı değildir; zaman yönetimi ve sınav psikolojisi de başarının temel taşlarındandır. Yükselİn Akademi'de, öğrencilerimize <strong>birebir matematik İzmir</strong> programları kapsamında deneme sınavlarında zaman kazandıracak turlama tekniği ve yeni nesil soru analiz yöntemleri kazandırıyoruz. Her hafta düzenli olarak yapılan deneme takip analizleri ile öğrencinin gelişimi izlenir ve yanlış yapılan sorular üzerinden nokta atışı telafiler gerçekleştirilir. Böylece sınav kaygısı başarı motivasyonuna dönüştürülür.</p>
                  
                  <h3>Geleceğin Kapılarını Güvenle Aralayın</h3>
                  <p>Matematikte kazanılacak başarı, mühendislikten tıbba kadar pek çok prestijli mesleğin kapısını aralamaktadır. Yükselİn Akademi olarak sunduğumuz nitelikli eğitim ve rehberlik desteğiyle, öğrencilerimizin hedeflerine giden yolda en güvenilir rehberi oluyoruz. Siz de YKS ve lise derslerinde fark yaratmak, netlerinizi kısa sürede artırmak ve hayalinizdeki üniversiteyi kazanmak için İzmir genelinde sunduğumuz özel ders olanaklarımızdan yararlanabilirsiniz.</p>
                `
              }}
            />
